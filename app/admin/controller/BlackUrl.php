...
class BlackUrl  extends BaseController
{
    ...
    public function add(){
        ...
        return View::fetch('/BlackUrl/black_add');
    }


    public function addpost(){
        $data = Request::post();
        if(Db::table('tp_black_url')->strict(false)->data($data)->insert()){
    ...
    public function list(){
        ...
        $list = Db::table('tp_black_url')->order('itemid','desc')->paginate([
            'list_rows' => Config::get('app.admin_page_num'),
            'path'     => "/".Config::get("app.admin_path").'/black_url/list',
        ]);
        ...
        View::assign('admin_path',Config::get('app.admin_path'));
        View::assign('pc_url',Config::get('app.admin_url'));
        return View::fetch('/BlackUrl/black_list');
    }

    public function edit(){
        $itemid = Request::param('itemid');
        $data = Db::table('tp_black_url')->where('itemid',$itemid)->select();
        View::assign('data',$data);
        View::assign('username',Session::get('username'));
        View::assign('admin_path',Config::get('app.admin_path'));
        View::assign('pc_url',Config::get('app.admin_url'));
        return View::fetch('/BlackUrl/black_edit');
    }

    public function editpost(){
        $data = Request::param();
        if(Db::table('tp_black_url')->strict(false)->where('itemid',$data['itemid'])->update($data)){
    ...
    public function delete(){
        ...
        if(Db::table('tp_black_url')->where('itemid',$itemid)->delete()){
